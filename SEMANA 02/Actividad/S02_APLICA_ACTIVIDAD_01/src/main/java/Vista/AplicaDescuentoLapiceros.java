...
public class AplicaDescuentoLapiceros extends javax.swing.JFrame {
    
    int docenas,lapiceroRegalado;
    double importeActual, descuento, importeFinal, precio;
    
    public AplicaDescuentoLapiceros() {
        initComponents();
        formulario();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AplicaDescuentoLapiceros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AplicaDescuentoLapiceros().setVisible(true);
            }
        });
    }
